...
replicate       = 1;                           % If you want this processing to be saved in another folder
date            = 9172022;                 % Date of the experiments
St              = 1;                            % 0: if it is pulsatile 1: if it is steady
Re              = 1425;
Test_num        = 55;
Trl             = 1;
PRF             = 25;
...
Dir = 'W:\Projects\DoVeR\Data\FinalImages\DopplerImages\FinalTests\';
Analysis_Dir = 'W:\Projects\DoVeR\Data\DataAnalysis\FinalImagesAnalysis\CDI\';   
end
